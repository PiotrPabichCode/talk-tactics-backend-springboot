...
public class UserCourseServiceTests {
    ...
    public void UserCourseService_AddUserCourse_ThrowsEntityExistsException() {
        UserCourseAddReqDto userCourseAddReqDto = new UserCourseAddReqDto(
                userCourseList.get(0).getCourse().getId(),
                userCourseList.get(0).getUser().getId()
        );
    ...
    public void UserCourseService_DeleteUserCourse_ReturnsNothing() {
        UserCourseDeleteReqDto userCourseDeleteReqDto = new UserCourseDeleteReqDto(
                userCourseList.get(0).getCourse().getId(),
                userCourseList.get(0).getUser().getId()
        );
