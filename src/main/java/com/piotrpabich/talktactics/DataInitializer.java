...
import com.piotrpabich.talktactics.util.CourseDataGenerator;
import com.piotrpabich.talktactics.util.UserProfileBioGenerator;
...
public class DataInitializer implements ApplicationRunner {
    ...
    private void initCourseItems() {
        try {
            JsonNode rootNode = readJsonFile("src/main/java/com/piotrpabich/talktactics/util/long_words.json");
